accelerate launch --config_file examples/flux/model_training/full/accelerate_config.yaml examples/flux/model_training/train.py \
  ...
  --dataset_metadata_path /fi-lib/workspace/sjx/DiffSynth-Studio/dataset/spotlight_sketch_cat/pairs.txt \
  ...
  --output_path "./models/train/FLUX.1_lora_spotlight_1203" \
  --lora_base_model "dit" \
  --lora_target_modules "a_to_qkv,b_to_qkv,ff_a.0,ff_a.2,ff_b.0,ff_b.2,a_to_out,b_to_out,proj_out,norm.linear,norm1_a.linear,norm1_b.linear,to_qkv_mlp" \
  --lora_rank 32 \
  --align_to_opensource_format \
  --use_gradient_checkpointing  > flux_train_1203.log 2>&1