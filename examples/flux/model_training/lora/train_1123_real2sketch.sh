accelerate launch --config_file examples/flux/model_training/full/accelerate_config.yaml examples/flux/model_training/train.py \
  --dataset_base_path /fi-lib/workspace/sjx/dataset/sketch_samples \
  --dataset_metadata_path /fi-lib/workspace/sjx/DiffSynth-Studio/dataset/sketch_samples/pairs.txt \
